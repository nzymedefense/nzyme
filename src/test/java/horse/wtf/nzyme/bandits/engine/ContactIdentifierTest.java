...
public class ContactIdentifierTest {
    ...
    public void testRegisterBandit() {
        ...
        i.registerBandit(Bandit.create(uuid1, "foo", "foo", DateTime.now(), DateTime.now(), Lists.newArrayList()));
        assertEquals(i.getBandits().size(), 1);

        UUID uuid2 = UUID.randomUUID();
        i.registerBandit(Bandit.create(uuid2, "foo", "foo", DateTime.now(), DateTime.now(), Lists.newArrayList()));
    ...
    public void testRegisterContact() {
        ...
        Bandit bandit1 = Bandit.create(UUID.randomUUID(), "foo", "foo", DateTime.now(), DateTime.now(), Lists.newArrayList());
        ...
        Bandit bandit2 = Bandit.create(UUID.randomUUID(), "foo", "foo", DateTime.now(), DateTime.now(), Lists.newArrayList());
    ...
    public void testBanditHasActiveContact() {
        ...
        assertFalse(i.banditHasActiveContact(Bandit.create(UUID.randomUUID(), "foo", "foo", DateTime.now(), DateTime.now(), Lists.newArrayList())));
    }
    ...
    public void testIdentifyMatchesSimple() throws MalformedFrameException, IllegalRawDataException {
        ...
        Bandit bandit1 = Bandit.create(UUID.randomUUID(), "foo", "foo", DateTime.now(), DateTime.now(), new ArrayList<BanditIdentifier>(){{
    ...
    public void testIdentifyMatchesMultiple() throws MalformedFrameException, IllegalRawDataException {
        ...
        Bandit bandit2 = Bandit.create(UUID.randomUUID(), "foo", "foo", DateTime.now(), DateTime.now(), new ArrayList<BanditIdentifier>(){{
    ...
    @Test
    public void testIdentifyIgnores() {
