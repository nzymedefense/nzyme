...
@AutoValue
public abstract class Dot11AssociationRequestFrame extends Dot11Frame {
    ...
    public static Dot11AssociationRequestFrame create(String ssid, String destination, String transmitter, Dot11MetaInformation meta) {
        return builder()
                .ssid(ssid)
