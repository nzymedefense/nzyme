...
public abstract class TablesReport {
    ...
    @JsonCreator
    public static TablesReport create(@JsonProperty("tap_name") String tapName, @JsonProperty("timestamp") DateTime timestamp, @JsonProperty("arp") Map<String, Map<String, Long>> arp) {
        return builder()
                .tapName(tapName)
                .timestamp(timestamp)
                .arp(arp)
