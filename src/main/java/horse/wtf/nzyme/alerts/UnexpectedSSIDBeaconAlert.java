...
public class UnexpectedSSIDBeaconAlert extends Alert  {
    ...
    private UnexpectedSSIDBeaconAlert(DateTime timestamp, Subsystem subsystem, Map<String, Object> fields) {
    ...
    public static UnexpectedSSIDBeaconAlert create(String ssid, String bssid, Dot11MetaInformation meta) {
        ...
        return new UnexpectedSSIDBeaconAlert(DateTime.now(), Subsystem.DOT_11, fields.build());
    }
