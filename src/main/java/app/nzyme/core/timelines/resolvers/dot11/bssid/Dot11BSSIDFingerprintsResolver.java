...
public class Dot11BSSIDFingerprintsResolver extends TimelineResolver {

    public Dot11BSSIDFingerprintsResolver(NzymeNode nzyme, UUID organizationId, UUID tenantId) {
