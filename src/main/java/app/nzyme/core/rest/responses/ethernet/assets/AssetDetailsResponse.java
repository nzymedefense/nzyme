...
public abstract class AssetDetailsResponse {
    ...
    public static AssetDetailsResponse create(UUID uuid, EthernetMacAddressResponse mac, String dhcpFingerprintInitial, String dhcpFingerprintRenew, String dhcpFingerprintReboot, String dhcpFingerprintRebind, DateTime firstSeen, DateTime lastSeen) {
        return builder()
                .uuid(uuid)
                .mac(mac)
