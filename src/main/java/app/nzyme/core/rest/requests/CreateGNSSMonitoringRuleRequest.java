...
@AutoValue
public abstract class CreateGNSSMonitoringRuleRequest {
    ...
    public static Builder builder() {
        return new AutoValue_CreateGNSSMonitoringRuleRequest.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract CreateGNSSMonitoringRuleRequest build();
    }
}
