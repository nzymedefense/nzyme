...
@AutoValue
public abstract class DHCPTransaction {
    ...
    public static Builder builder() {
        return new AutoValue_DHCPTransaction.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract DHCPTransaction build();
    }
}
