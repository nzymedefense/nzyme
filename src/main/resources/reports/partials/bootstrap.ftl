 ...
 */
    ...
    *::after {
    ...
    .valid-tooltip {
        ...
        line-height: 1;
        color: #fff;
        background-color: rgba(23, 176, 107, 0.8);
        border-radius: .2rem; }
    ...
    .was-validated .custom-control-input:valid:focus ~ .custom-control-label::before, .custom-control-input.is-valid:focus ~ .custom-control-label::before {
        -webkit-box-shadow: 0 0 0 1px #0c0d16, 0 0 0 0.2rem rgba(23, 176, 107, 0.25);
        box-shadow: 0 0 0 1px #0c0d16, 0 0 0 0.2rem rgba(23, 176, 107, 0.25); }
    ...
    .invalid-tooltip {
        ...
        line-height: 1;
        color: #fff;
        background-color: rgba(255, 60, 92, 0.8);
        border-radius: .2rem; }
    ...
    .was-validated .custom-control-input:invalid:focus ~ .custom-control-label::before, .custom-control-input.is-invalid:focus ~ .custom-control-label::before {
        -webkit-box-shadow: 0 0 0 1px #0c0d16, 0 0 0 0.2rem rgba(255, 60, 92, 0.25);
        box-shadow: 0 0 0 1px #0c0d16, 0 0 0 0.2rem rgba(255, 60, 92, 0.25); }
    ...
    .custom-checkbox .custom-control-input:checked ~ .custom-control-label::after {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%2332334a' d='M6.564.75l-3.59 3.612-1.538-1.55L0 4.26 2.974 7.25 8 2.193z'/%3E%3C/svg%3E"); }

    .custom-checkbox .custom-control-input:indeterminate ~ .custom-control-label::before {
        background-color: #2983fe; }

    .custom-checkbox .custom-control-input:indeterminate ~ .custom-control-label::after {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 4'%3E%3Cpath stroke='%2332334a' d='M0 2h4'/%3E%3C/svg%3E"); }
    ...
    .custom-radio .custom-control-input:checked ~ .custom-control-label::after {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3E%3Ccircle r='3' fill='%2332334a'/%3E%3C/svg%3E"); }
    ...
    .custom-select {
        ...
        color: #adabc6;
        vertical-align: middle;
        background: #32334a url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3E%3Cpath fill='%2311111d' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E") no-repeat right 0.75rem center;
    ...
    .custom-select:focus {
        border-color: #c7b8f2;
        outline: 0;
        -webkit-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(199, 184, 242, 0.5);
        box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(199, 184, 242, 0.5); }
    ...
    .navbar-dark .navbar-toggler-icon {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath stroke='rgba(50, 51, 74, 0.5)' stroke-width='2' stroke-linecap='round' stroke-miterlimit='10' d='M4 7h22M4 15h22M4 23h22'/%3E%3C/svg%3E"); }
    ...
    .carousel-control-prev-icon {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%2332334a' viewBox='0 0 8 8'%3E%3Cpath d='M5.25 0l-4 4 4 4 1.5-1.5-2.5-2.5 2.5-2.5-1.5-1.5z'/%3E%3C/svg%3E"); }

    .carousel-control-next-icon {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%2332334a' viewBox='0 0 8 8'%3E%3Cpath d='M2.75 0l-1.5 1.5 2.5 2.5-2.5 2.5 1.5 1.5 4-4-4-4z'/%3E%3C/svg%3E"); }
    ...
    .carousel-indicators li {
        ...
        text-indent: -999px;
        cursor: pointer;
        background-color: rgba(50, 51, 74, 0.5); }
    ...
    a.text-primary:hover, a.text-primary:focus {
        color: #5126d2 !important; }

    .text-secondary {
        color: #16a4de !important; }

    a.text-secondary:hover, a.text-secondary:focus {
        color: #1182b0 !important; }

    .text-success {
        color: #17b06b !important; }

    a.text-success:hover, a.text-success:focus {
        color: #118350 !important; }
    ...
    a.text-danger:hover, a.text-danger:focus {
        color: #ff0931 !important; }

    .text-light {
        color: #dbebfb !important; }

    a.text-light:hover, a.text-light:focus {
        color: #add2f6 !important; }
