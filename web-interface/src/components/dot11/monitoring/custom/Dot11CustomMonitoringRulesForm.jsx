...
import conditionTypeToTitle from "./conditions/Dot11CustomMonitoringConditionTypeTitleFactory";
import Dot11CustomMonitoringAPBSSIDForm from "./conditions/forms/Dot11CustomMonitoringAPBSSIDForm";
import conditionTypeSetToDescription from "./conditions/descriptions/Dot11CustomMonitoringConditionsDescriptionFactory";
import useSelectedTenant from "../../../system/tenantselector/useSelectedTenant";
import LoadingSpinner from "../../../misc/LoadingSpinner";

const tapsService = new TapsService();

export default function Dot11CustomMonitoringRulesForm(props) {
  ...
  const [selectedConditionType, setSelectedConditionType] = useState("AP_BSSID");
  ...
  const newConditionForm = () => {
    ...
    switch (conditionFormType) {
      case "AP_BSSID":
        form = <Dot11CustomMonitoringAPBSSIDForm onConditionAdded={onConditionAdded} />;
        break;
    }
    ...
    <form>
      ...
      <div className="input-group mb-3">
        <select className="form-control"
          ...
          <option value="AP_BSSID">{conditionTypeToTitle("AP_BSSID")}</option>
        </select>
