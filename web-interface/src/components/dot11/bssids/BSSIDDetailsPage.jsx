  ...
  return (
      <React.Fragment>
        <div className="row">
          <div className="col-md-12">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item">{bssid.summary.bssid}</li>
          ...
          <div className="col-md-12">
            <h1>
              BSSID &quot;{bssid.summary.bssid} ({bssid.summary.oui ? bssid.summary.oui : "Unknown Vendor"})&quot;
            </h1>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <dl className="mb-0">
                  <dt>MAC Address</dt>
                  <dd>
                    <span className="dot11-mac">{bssid.summary.bssid}</span>
                  </dd>
                  <dt>Vendor</dt>
                  <dd>
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-body">
                    ...
                    <BSSIDAdvertisementHistogram bssid={bssid.summary.bssid} parameter="beacon_count" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-body">
                    ...
                    <BSSIDAdvertisementHistogram bssid={bssid.summary.bssid} parameter="proberesp_count" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-body">
                    ...
                    <BSSIDChannelUsageHistogram bssid={bssid.summary.bssid} minutes={24*60} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <DiscoHistogram discoType="disconnection" minutes={24*60} bssids={[bssid.summary.bssid]} />
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <DiscoPairsTable bssids={[bssid.summary.bssid]} highlightValue={bssid.summary.bssid} />
