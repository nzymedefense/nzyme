...
export default function CreateCotOutputPage() {
  ...
  const onFormSubmitted = (name, description, tapLeafType, address, port, onFailure) => {
    cotIntegrationService.createOutput(organizationId, tenantId, name, description, tapLeafType, address, port, () => {
