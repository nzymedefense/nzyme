...
export default function L4SessionsTopTrafficDestinationAddressesHistogram({filters, setFilters, timeRange, revision}) {
  ...
  useEffect(() => {
    setData(null);
    l4Service.getTopTrafficDestinationAddresses(organizationId, tenantId, selectedTaps, filters, timeRange, limit, 0, setData)
  ...
  return <ThreeColumnHistogram data={data}
                               columnFilterElements={[
                                 {field: "destination_address", valueSubField: "address", fields: L4_SESSIONS_FILTER_FIELDS, setFilters: setFilters},
                                 null, null
                               ]}
                               columnTitles={["Destination Address", "RX", "TX"]}
                               limit={limit}
                               setLimit={setLimit} />
