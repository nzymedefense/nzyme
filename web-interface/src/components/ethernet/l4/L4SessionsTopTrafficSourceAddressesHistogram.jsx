...
export default function L4SessionsTopTrafficSourceAddressesHistogram({filters, setFilters, timeRange, revision}) {
  ...
  useEffect(() => {
    setData(null);
    l4Service.getTopTrafficSourceAddresses(organizationId, tenantId, selectedTaps, filters, timeRange, limit, 0, setData)
  ...
  return <ThreeColumnHistogram data={data}
                               columnFilterElements={[
                                 {field: "source_address", valueSubField: "address", fields: L4_SESSIONS_FILTER_FIELDS, setFilters: setFilters},
                                 null, null
                               ]}
                               columnTitles={["Source Address", "RX", "TX"]}
                               limit={limit}
                               setLimit={setLimit} />
